...
For usage examples of `gdal-summarize.py` and a comparison with R, look at [this document](https://github.com/mstrimas/gdal-summarize/blob/master/raster-summarize.md) on the GitHub repo.
